...
dogDiv.prepend("<div><img src='images/fish.png' width = 200></div>")
dogDiv.append("<div><img src='images/cat.png' width = 200></div>")
...
let gradeAPIURL = `http://localhost:3000/gradebook`;

$.get(gradeAPIURL, (data) => {
	console.log(data);
});

$.get(`${gradeAPIURL}/7`, (data) => {
	console.log(data);
	let resultsDiv = $('.result')
	resultsDiv.append(`${data.firstname} ${data.lastname}, Grade:${data.grade}%`)
});

$.get(`${gradeAPIURL}/15`, (data) => {
	console.log(data);
	let resultsDiv = $('.new')
	resultsDiv.append(`${data.firstname} ${data.lastname}, Grade:${data.grade}%`)
});
